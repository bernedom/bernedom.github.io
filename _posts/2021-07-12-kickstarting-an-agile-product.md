...
The stakeholder map, vision, and quality criteria tend to have a longer lifespan but nevertheless take them up frequently. Make these documents visible in your daily stand-ups and do over them in detail whenever you talk about the longer future like when building an [agile road-map](https://softwarecraft.ch/Agile-Roadmapping/). 